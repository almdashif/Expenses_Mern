...
const Announcement = ({ navigation }) => {
  ...
  const OpenBottomSheet = async (item) => {
    ...
    const updatedData = cstate.ShowAnnouncementCount.map(data => {
    ...
    await cdispatch({ type: "ShowAnnouncementCount", payload: updatedData });
  ...
  const AdminImageRegistry_Select = async (ID) => {
    try {
      ...
      await CommonAPISelectWT(
        ...
        cdispatch({ type: 'CCMComplaintAnnouncementDetailImageDatas', payload: ImageBind });
        cdispatch({ type: 'CCMComplaintAnnouncementDetailAudioDatas', payload: AudioBind });
        cdispatch({ type: 'CCMComplaintAnnouncementDetailVideoDatas', payload: VideoBind });
      });
    } catch (error) {
      logger.log(error);
    }
  ...
  return (
    <View style={CommonStyles.CommonFlex}>
      <View style={[CommonStyles.CommonHeaderView2, { backgroundColor: Commoncolor.CommonAppColor }]}>
        ...
        <Text style={CommonStyles.CommonHeaderViewText}>Announcement</Text>
      </View>

      <View style={CommonStyles.CommonHeaderView3}>
        <ScrollView showsHorizontalScrollIndicator={false}>
          {cstate.Announcement_images.map((item, index) => (
            <TouchableOpacity
          ...
          {cstate.Announcement_video.map((item, index) => (
            ...
            >
              <TouchableOpacity
                ...
                onPress={() => toggleVideoPlay(index, item.FilePath)}
              >
                <Icon1 name={"controller-play"} size={Commonsize(30)} style={[CommonStyles.HomeTopIcon, { color: Commoncolor.CommonAppColor, marginLeft: Commonwidth(5), }]} />
              </TouchableOpacity>
              <View
                style={{
                  width: Commonwidth(50),
        ...
        {cstate.CCMComplaintDetailDatas && cstate.CCMComplaintDetailDatas?.length != 0 ? <>
          ...
          >
            <View style={[{
              ...
              <View style={{ width: '100%', height: Commonheight(180), justifyContent: 'center', alignItems: "center", }}>
                <ScrollView showsHorizontalScrollIndicator={false} horizontal={true} style={{ width: Commonwidth(360), height: '100%', overflow: 'hidden' }}>
                  {cstate.CCMComplaintAnnouncementDetailImageDatas.map((item, index) => (
                    <View
                      key={index}
                      style={{
                  ...
                  {cstate.CCMComplaintAnnouncementDetailVideoDatas.map((item, index) => (
                    <TouchableOpacity
                    ...
                    >
                      ...
                      <Video
                        ...
                        style={{
                          ...
                          width: '100%',
                          height: Commonheight(120),
                          borderTopLeftRadius: Commonwidth(20),
                          borderTopRightRadius: Commonwidth(20),
                          overflow: 'hidden'
                        }}
                        resizeMode="cover"
                  ...
                  {cstate.CCMComplaintAnnouncementDetailAudioDatas.map((item, index) => (
                    <TouchableOpacity
              ...
              <View style={{ flex: 1, paddingHorizontal: Commonwidth(10), paddingTop: Commonheight(20), paddingBottom: Commonheight(2),backgroundColor:Commoncolor.CommonWhiteColor }}>
                {/* title feilds  */}
...
{/* <SliderBox
                  ...
                  disableOnPress={true}
                  resizeMode='stretch'
                  sliderBoxHeight={Commonheight(190)}
                  dotColor={Commoncolor.CommonAppColor}
                  inactiveDotColor={Commoncolor.CommonGrayColor}
                  dotStyle={{
                    width: Commonsize(8),
                    height: Commonsize(8),
                    borderRadius: Commonsize(10),
                  ...
                  style={{ width: Commonwidth(360), height: Commonheight(200), marginTop: Commonheight(-4) }}
                /> */}